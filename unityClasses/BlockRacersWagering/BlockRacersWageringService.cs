...
using BlockRacersWagering.BlockRacersWagering.ContractDefinition;

namespace BlockRacersWagering.BlockRacersWagering
{
    public partial class BlockRacersWageringService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BlockRacersWageringDeployment blockRacersWageringDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockRacersWageringDeployment>().SendRequestAndWaitForReceiptAsync(blockRacersWageringDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BlockRacersWageringDeployment blockRacersWageringDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockRacersWageringDeployment>().SendRequestAsync(blockRacersWageringDeployment);
        }

        public static async Task<BlockRacersWageringService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BlockRacersWageringDeployment blockRacersWageringDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, blockRacersWageringDeployment, cancellationTokenSource);
            return new BlockRacersWageringService(web3, receipt.ContractAddress);
        }
        ...
        public BlockRacersWageringService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BlockRacersWageringService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
