...
using BlockGameToken.BlockGameToken.ContractDefinition;

namespace BlockGameToken.BlockGameToken
{
    public partial class BlockGameTokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BlockGameTokenDeployment blockGameTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockGameTokenDeployment>().SendRequestAndWaitForReceiptAsync(blockGameTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BlockGameTokenDeployment blockGameTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockGameTokenDeployment>().SendRequestAsync(blockGameTokenDeployment);
        }

        public static async Task<BlockGameTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BlockGameTokenDeployment blockGameTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, blockGameTokenDeployment, cancellationTokenSource);
            return new BlockGameTokenService(web3, receipt.ContractAddress);
        }
        ...
        public BlockGameTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BlockGameTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
